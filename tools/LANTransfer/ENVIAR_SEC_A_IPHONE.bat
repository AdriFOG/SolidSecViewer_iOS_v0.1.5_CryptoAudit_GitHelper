...
title SolidSec PC Bridge - Enviar .sec

echo.
echo ============================================================
echo   SolidSec - Enviar SOLO archivos cifrados .sec al iPhone
echo ============================================================
echo.
...
echo   SolidSec ^> Mi boveda ^> Wi-Fi ^> Recibir .sec desde PC
echo.
...
if "%RC%"=="0" (
    echo ============================================================
    echo   TRANSFERENCIA ENVIADA
    echo ============================================================
    echo.
    echo No borres tu ZIP/carpeta de la PC hasta que el iPhone muestre:
    echo   "Coleccion .sec guardada"
) else (
